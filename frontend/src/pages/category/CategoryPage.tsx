...
import {
  ...
  ArticleError,
} from "../../components/news/articledetails/ArticleStates";
import { SubscribeButton } from "../../components/category/SubscribeButton";
...
export const CategoryPage = () => {
  ...
  const categoryName = getCategoryNameUppercase(category || "");
    ...
    return (
      <div className="container-main py-12 text-center">
        <h2 className="text-2xl font-bold text-gray-500 dark:text-gray-400">
          Không tìm thấy bài viết cho chuyên mục này.
        </h2>
      </div>
    );
  }
