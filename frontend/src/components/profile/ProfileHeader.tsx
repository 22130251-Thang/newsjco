import { Camera, Calendar, Edit, Key } from "lucide-react";
...
export const ProfileHeader = ({ user, onAvatarClick, onEditClick, onPasswordClick }: ProfileHeaderProps) => {
    ...
    <div className="bg-red-700 dark:bg-red-800 rounded-t-lg p-6">
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
        ...
        <div className="flex flex-col gap-2 sm:ml-auto">
          <button
            onClick={onEditClick}
            className="flex items-center gap-2 px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-lg transition-colors backdrop-blur-sm cursor-pointer"
          >
            <Edit size={16} />
