...
export const RightSidebar = () => {
    return (
        <div className="space-y-6">
            <div>
                <div className="bg-[#00529c] text-white text-center py-2.5 font-bold uppercase text-[15px] mb-4">
                    MỜI ĐỌC BÁO IN
                </div>
                <div className="space-y-4 px-4">
                    <a href="#" className="block">
                        <img
                            src="https://placehold.co/260x80/white/cc0000?text=TUAN+TIN+TUC"
                            alt="Tuần tin tức"
                    ...
                    <a href="#" className="block">
                        <img
                            src="https://placehold.co/260x80/white/cc0000?text=DAN+TOC+VA+MIEN+NUI"
